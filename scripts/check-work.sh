...
TEST_FILE="$ROOT_DIR/molecule/default/tests/test_many_ships.py"
...
echo -e "  Mission 1.4: One Playbook, Many Ships"
echo -e "  ==============================================${RESET}"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo -e ""
    echo -e "  Midshipman, Marauder Copy-Paste has been defeated."

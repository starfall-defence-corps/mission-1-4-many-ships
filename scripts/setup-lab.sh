...
echo ""
echo "  MIXED-OS FLEET:"
echo "    sdc-web   (Ubuntu 22.04)   port 2221"
echo "    sdc-db    (Rocky Linux 9)  port 2222"
echo "    sdc-comms (Ubuntu 22.04)   port 2223"
echo ""
echo "  Corporal Copy-Paste wrote 47 playbooks."
echo "  You will write ONE."
echo ""
